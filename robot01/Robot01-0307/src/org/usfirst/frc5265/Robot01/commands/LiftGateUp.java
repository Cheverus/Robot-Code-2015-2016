...
public class LiftGateUp extends Command {
	...
	Robot.gateLifter.enable();
   		if(fingerToggle == 1){
   	
    	Robot.gateLifter.setSetpoint(SmartDashboard.getNumber("upperPotLimitFinger"));
    	
	    } else if (fingerToggle == -1) {
	    Robot.gateLifter.setSetpoint(SmartDashboard.getNumber("lowerPotLimitFinger"));
    ...
    protected boolean isFinished() {
    	GateLifter.fingerButtonToggle();
        return Robot.gateLifter.onTarget();
    }
