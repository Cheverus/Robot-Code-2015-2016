...
public class Robot extends IterativeRobot {
 ...
 //   public static GateLifter gateLifter;
    ...
    public static int fingerButton;
    ...
    public static double autoTime = 2;
    public static double autoSpeed = -0.8;
 ...
 */   
    ...
    public void autonomousInit() {
    	...
    	//
    	autoSpeed = SmartDashboard.getNumber("auto speed");
    	autoTime = SmartDashboard.getNumber("auto time");
    	RobotMap.driveBaseRobotDrive.setSafetyEnabled(false);
    	
    	
    	while(Timer.getMatchTime() < autoTime)
    		{
    		Robot.driveBase.autoDrive(autoTime, autoSpeed);
    		
    		}
    	RobotMap.driveBaseRobotDrive.setSafetyEnabled(true);
    	
        // Robot.driveBase.GoStop(0);
    	// RobotMap.driveBaseRobotDrive.setSafetyEnabled(true);

    	// while(Timer.delay(autoTime)  <Timer.getMatchTime() > 15;)
    	...
    	//}while(detectTime() < 1000 * autoTime);
    	// is time in seconds or milliseconds? I believe it is SECONDS! This sets autonomous for 2,000 seconds, since our default is 2 secs
    	Robot.driveBase.GoStop(0);
    	*/
    }
